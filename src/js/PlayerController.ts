import { Engine, UniversalCamera, Scene, Vector3, Mesh, MeshBuilder, PBRMaterial, Texture, Color3, StandardMaterial, KeyboardEventTypes, PointerEventTypes, KeyboardInfo, DeviceSourceManager, DeviceType } from "babylonjs";
